      ...
      <div class="box">
        ...
        <div class="box-body">
          <table id="example1" class="table table-bordered table-striped">
            ...
            <tbody>
            	<?php 
            		$sql = "select * from pegawai where stts_aktif='AKTIF' AND bidang='Clean. Service' ORDER BY jbtn ASC";
                ...
                <td>
                  ...
                  <a target="_blank" href="index.php?p=penilaian&act=nilai_cs&id=<?= $row['id'] ?>" class="create"><button class="glyphicon glyphicon-edit" data-toggle="tooltip" title="Penilaian"></button></a>				  
                </td>
            	 	<td></td>
            	 </tr>
